		...
		<div id="area_content_main">
			...
			<div class="elem_pic">
				<div class="center elem_pic_pad">
					<img src="http://www.jetro.go.jp/library/j-messe/images/db/fair03.jpg" alt="fairstep2" />
				</div>
			</div>
				...
				<div class="elem_table_basic">
					...
					<table id="registration" class="var_there_boder var_base_color elem_table_basic var_ptb8">
						...
						{else}
							<tr>
						{/if}
								<th class="bg_gray_lv1 nobdr">対象</th>
										...
										<ul class="liner">
											<li>
												<div class="elem_custom_input pt0 pb0">
													...
													<strong>人</strong>うち海外から
												</div>
											</li>
											<li>
												<div class="elem_custom_input pt0 pb0">
													<input type="text" value="{$form.number_of_foreign_visitor}" size="10" name="number_of_foreign_visitor" id="number_of_foreign_visitor" maxlength="10" class="var_bg_white var_size_short" />
													<strong>人</strong>
												</div>
											</li>
										</ul>
						...
						{else}
							<tr>
						{/if}
								<th class="bg_gray_lv1 nobdr">総出社数</th>
								<th class="bg_gray_lv1"></th>
								<td class="bg_gray_lv2">
									<div class="elem_form_list pt0 pb0">
										<ul class="liner">
											<li>
												<div class="elem_custom_input pt0 pb0">
													...
													<strong>社</strong>うち海外から
												</div>
											</li>
											<li>
												<div class="elem_custom_input pt0 pb0">
													<input type="text" value="{$form.number_of_foreign_exhibitors}" size="10" name="number_of_foreign_exhibitors" id="number_of_foreign_exhibitors" maxlength="10" class="var_bg_white var_size_short" />
													<strong>社</strong>
												</div>
											</li>
										</ul>
						...
						{else}
							<tr>
						{/if}
								<th class="bg_gray_lv1 nobdr">開催規模</th>
								<th class="bg_gray_lv1"></th>
								<td class="bg_gray_lv2">
									<div class="elem_custom_input pt0 pb0">
										<input type="text" value="{$form.net_square_meters}" size="50" name="net_square_meters" id="net_square_meters" maxlength="50" class="var_bg_white var_size_middle" />
										<strong>sq.m.</strong><br />
										半角数字のみ入力して下さい。","(カンマ)は使用しないで下さい。例：1000
									</div>
									{if is_error('net_square_meters')}
				...
				<div class="elem_table_basic">
					...
					<table id="registration" class="var_there_boder var_base_color elem_table_basic var_ptb8">
						...
						{/if}
								...
								<td class="bg_gray_lv2">
									<div class="elem_custom_input pt0 pb0">
										<textarea cols="60" rows="5" name="detailed_information_jp" id="detailed_information_jp" class="var_bg_white">{$form.detailed_information_jp}</textarea><br/>
										同時開催/併催展がある場合にはこちらにご記入をお願いします。1000文字以内で。
									</div>
									{if is_error('detailed_information_jp')}
						...
						{/if}
								...
								<td class="bg_gray_lv2">
									<div class="elem_custom_input pt0 pb0">
										複数指定が可能です(5つまで)。複数指定の際は、半角コンマ「,」で区切ってご入力ください。
					...
					<table id="registration" class="var_there_boder var_base_color elem_table_basic var_ptb8">
						...
						<tbody>
							...
							{else}
								<tr>
							{/if}
									<th class="bg_gray_lv1 nobdr">主催者</th>
									<th class="bg_gray_lv1"><span class="cate">必須</span></th>
									<td class="bg_gray_lv2">
										<div class="elem_custom_input pt0 pb0">
											名称<input type="text" value="{$form.organizer_jp}" size="60" name="organizer_jp" id="organizer_jp" maxlength="500" class="var_bg_white var_size_large" />
										</div>
										{if is_error('organizer_jp')}
							...
							{else}
								<tr>
							{/if}
									<th class="bg_gray_lv1 nobdr">主催者連絡先</th>
									<th class="bg_gray_lv1"><span class="cate">必須</span></th>
									<td class="bg_gray_lv2">
										<div class="elem_text_list_note">
											<table class="elem_text_list_note">
												...
												<tbody>
													<tr>
														<th class="elem_text_list_note">住所</th>
													...
													<tr>
														<th class="elem_text_list_note">担当部課</th>
														<td class="elem_text_list_note">
															<div class="elem_custom_input pt0">
													...
													<tr>
														<th class="elem_text_list_note">担当者</th>
														<td class="elem_text_list_note">
															<div class="elem_custom_input pt0">
													...
													<tr>
														<th class="elem_text_list_note"><span class="cate">必須</span>TEL</th>
														<td class="elem_text_list_note">
															<div class="elem_custom_input pt0">
							...
							{/if}
									...
									<td class="bg_gray_lv2">
										<div class="elem_paragraph">
											<p class="text">海外で開催される見本市で、日本国内に問い合わせ先がある場合</p>
										</div>
										<div class="elem_text_list_note">
											<table class="elem_text_list_note">
												<colgroup>
												...
												<tbody>
													<tr>
														<th class="elem_text_list_note">名称</th>
														<td class="elem_text_list_note">
															<div class="elem_custom_input pt0">
																<input type="text" value="{$form.agency_in_japan_jp}" size="60" name="agency_in_japan_jp" id="agency_in_japan_jp" maxlength="255" class="var_bg_white var_size_large" />
															</div>
														</td>
													</tr>
													<tr>
							...
							<div class="elem_content_divide_box">
								<div class="elem_linkBox_list">
									<ul class="var_large_pad">
										<li>
											<div class="linkBox">
												<a href="{$config.url}?action_user_fairRegistStep1=true&mode={$form.mode}&mihon_no={$form.mihon_no}&back=1" class="var_small"><span class="left">戻る</span></a>
											</div>
										</li>
									</ul>
								</div>
							...
							<div class="elem_content_divide_box">
								<div class="elem_linkBox_list">
									<ul class="var_large_pad">
										<li>
											<div class="linkBox">
												<a href="{$config.url}?action_user_fairRegistStep1=true&back=1" class="var_small"><span class="left">戻る</span></a>
											</div>
										</li>
									</ul>
								</div>
							...
							<div class="elem_content_divide_box">
								<div class="elem_linkBox_list">
									<ul class="var_large_pad">
										<li>
											<div class="linkBox">
												<a href="javascript:next();" class="var_small"><span>次へ</span></a>
											</div>
										</li>
									</ul>
								</div>
