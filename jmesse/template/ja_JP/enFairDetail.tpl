	...
	<div id="area_content_wrap">
		...
		<div id="area_content_main">
			<div id="elem_heading_lv1">
				...
				{else}
					<span class="sub_text"><h1>{$app.fair_detail.fair_title_en}</h1></span>
				{/if}
			</div>
			...
			{if ('' != $app.fair_detail.fair_url)}
				<div class="elem_text_list">
					<ul>
						<li><strong><a class="link_blank" target="_blank" href="{$app.fair_detail.fair_url}">official site</a></strong></li>
					</ul>
				</div>
			{/if}
